...
import frc.robot.Vision.PhotonVisionSmoother;
...
public class CameraGoToTagCommand extends Command {
    ...
    private PhotonVisionSmoother smoother = new PhotonVisionSmoother(); 
    ...
    public CameraGoToTagCommand(CommandSwerveDrivetrain drivetrain_, double joystickInput_){
      ...
      .withDriveRequestType(DriveRequestType.OpenLoopVoltage);;
        ...
        centeringPID = new PIDController(0.01, 0, 0);
    ...
    public void execute(){
        ...
        for(PhotonTrackedTarget target : targets){
            ...
            if(targetID == 4 || targetID == 7){
                ...
                smoother.updateCoordinates(targetYaw, 0);
                double smoothedYaw = smoother.getSmoothedX();
                double centeringAdjustment = centeringPID.calculate(smoothedYaw);
