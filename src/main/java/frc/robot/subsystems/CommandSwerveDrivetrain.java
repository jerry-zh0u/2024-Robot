...
public class CommandSwerveDrivetrain extends SwerveDrivetrain implements Subsystem {
    ...
    public void init(){
        driveState.ModuleStates = new SwerveModuleState[4];
    }
    @Override
    public void periodic(){
        updatePose();
        updateModules();
        // System.out.println(Telemetry.getModuleStates()[0]);
        // System.out.println(driveState.Pose.getX());
        SmartDashboard.putNumber("Pose2d X", driveState.Pose.getX());
        SmartDashboard.putNumber("Pose2d Y", driveState.Pose.getY());
    }

    private void updatePose(){
        driveState.Pose = Telemetry.m_lastPose;
    }
    private void updateModules(){
        for (int i = 0; i < 4; i++) {
            driveState.ModuleStates[i] = Telemetry.getModuleStates()[i];
        }
    }
