...
public class IntakeSubsystem extends SubsystemBase{
    ...
    public IntakeSubsystem(){
        ...
        _retractMotor1 = new TalonFX(16);
        _retractMotor2 = new TalonFX(17);
        _helpMotor = new TalonFX(25); //FIXME
        
            // _helpMotor.setNeutralMode(NeutralMode.Brake);
...
//removed limit switch switch to falcon limit
    ...
    public void helper_On(){
        _helpMotor.set(0.2); 
    }
    public void helper_Off(){
        _helpMotor.set(0);
    }
